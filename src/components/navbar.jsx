const Navbar = (props) => {
    return (
        <nav className="py-4 bg-blue-600  flex justify-between">
           <div className="flex items-center mx-auto w-2/3 justify-between">
                <p className="text-white text-2xl md:text-4xl">UseReducer</p>
                <div className="cart-logo text-white relative">
                    ...
                    <span className="inline-block absolute text-xl flex justify-center items-center -top-2 left-6 amount px-2 bg-black rounded-full">{props.cartItems}</span>
                </div>
            </div> 
        </nav>
    )
